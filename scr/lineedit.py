...
class MyLineEdit(QLineEdit):
    ...
    def createFrameMiddle(self, FrameConstructor):
        ...
        leftLineEdit = MyLineEdit(self.parent)
        self.parent.children.insert(currentLineditPosition, leftLineEdit)
        leftLineEdit.setText(self.text()[:cursorPosition])
        self.setText(self.text()[cursorPosition:])
        newFrame.createLinks(leftLineEdit, self)
